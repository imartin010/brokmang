            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">Sarah K.</p>
            ...
            <CardContent className="space-y-3">
              <div className="p-4 rounded-lg bg-accent/50">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium">Morning Team Briefing</h4>
              ...
              <div className="p-4 rounded-lg bg-accent/50">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <h4 className="font-medium">Review Daily Logs</h4>
              ...
              <div className="p-4 rounded-lg bg-accent/50">
                <div className="flex items-center gap-3 mb-2">
                  <Clock className="h-5 w-5 text-orange-500" />
                  <div className="flex items-center gap-3 mb-2">
                    <h4 className="font-medium">One-on-One with Sarah</h4>
                    <p className="text-xs text-muted-foreground">Scheduled at 4:00 PM</p>
                  </div>
                </div>
              </div>
